from wall_app.models import PostMessage
...
def message_post(request):
    PostMessage.objects.create(
        content = request.POST['message'], #content is = to what's being put into textarea in wall.html line 18(in the form)
...
def comment(request, i_id):
    ...
    return render(request, 'mess_com.html', context)
