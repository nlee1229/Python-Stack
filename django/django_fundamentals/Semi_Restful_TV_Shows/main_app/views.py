...
def create_show(request):
    ...
    show_title = request.POST.get('title')
    show_network = request.POST.get('network')
    show_rel_date = request.POST.get('rel_date')
    show_descrip = request.POST.get('show_desc')
    new_show = Show.objects.create(
        title = show_title, 
        network = show_network, 
        rel_date = show_rel_date, 
        desc = show_descrip
        )
    id = new_show.id
